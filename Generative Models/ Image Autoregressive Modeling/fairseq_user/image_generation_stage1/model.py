...
@register_model("stlm", dataclass=STLMConfig)
class STTransformerLanguageModel(FairseqLanguageModel):
    ...
    def forward(
        ...
        **kwargs
        ...
        src, tgt = self.add_eos_shift(sem)
        ...
        output = {
            "word_ins_visual": {
                "out": logits,
                "mask": src.ne(self.decoder.padding_idx),
                "nll_loss": True,
                "factor": 1.0,
                "tgt": tgt
            },
