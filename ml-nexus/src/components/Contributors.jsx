        ...
        <>
            <div className="p-10 ">
                ...
                <div className="px-20 mt-6 flex flex-wrap gap-6">
                    {contributors.map((c, i) => <div key={i} className="h-48 w-48 bg-[#324655] rounded-lg flex flex-col items-center justify-between">
                        ...
                        <h1 className='text-md mb-2 bg-teal-800 px-4 py-2 rounded-full'>{c.login}</h1>
                    </div>)}
                </div>
            </div>
        </>
